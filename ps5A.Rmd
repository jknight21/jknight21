...
> ANSWER: The str_subset command returns the first 6 lines in the text with the word "Macbeth". The str_which command returns the indices that each of first 6 lines were found in. The str_detect command returns either "true" or "false" depending on if the keyword "Macbeth" is found.
...
> ANSWER: Using the str_subset command on "Macbeth\\" will return the first 6 mentions of Macbeth followed by a period. Using the same command on "Macbeth." will return the first 6 mentions of Macbeth, whether or not it is followed by a period.
...
> ANSWER: The first pattern will return any mentions of the character sequence "MAC" followed by any letters in the alphabet except for A. The second pattern will return any mentions of the character sequence "MAC", but only if followed by the letters B or Z. The third pattern returns any mentions of "MAC" followed by any letter except A, but only at the very beginning of the transcribed text.
