...
> RESPONSE: There are 1846 rows and 3 columns. The variables included are "dataset", "x", and "y".
...
> RESPONSE: The correlation coefficient is approximately -0.06. This implies there is essentially no relationship between the variables x and y.
...
> RESPONSE: There is no correlation between the data points, as the data points instead draw a graphic of a dinosaur.
...
> RESPONSE: The correlation coefficient is -0.06, almost identical to the correlation coefficient from the 'dino' dataset.
...
> RESPONSE: Despite having an almost identical correlation coefficient, this plot resembles a star, not a dinosaur.
...
> RESPONSE: Again, we have an almost identical correlation coefficient to our previous two, rounding to -0.07.
...
> RESPONSE: Nope, instead it draws out a circle.
...
> RESPONSE: The correlation coefficient is not an efficient summary for any of these data sets. Each dataset has an almost identical correlation coefficient, but each data set sketches a completely different design from any of the others.
