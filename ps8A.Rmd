...
> ANSWER: Figure 6.1 is an unethical representation of the data presented. The data is accurate, however the y-axis has been flipped, deceiving the viewer into thinking Florida's "stand your ground" law was successful in reducing deaths from firearms, when in actuality deaths increased.
...
> ANSWER: The situation presented about legal negotations raised some interesting points that I hadn't considered before, namely how to reproduce ethical data analysis in a courtroom setting.
...
> ANSWER: Yes, I believe that ethical questions are indeed raised when a flawed analysis is published. Data scientists absolutely have an obligation to be truthful in reporting the findings of their data analysis. Statistics are taken very seriously in a myriad of professional settings, and should not be unethically used to further any particular agenda. The conclusions should faithfully reflect the data, even the results are not "correct".
