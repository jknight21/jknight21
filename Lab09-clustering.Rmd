...
> ANSWER:  Amherst College and Tufts University.
...
> ANSWER: The solution with 5 clusters, the categories are smaller so there is less variability within the clusters.
...
> ANSWER: Different schools are now clustered together, making it different than if the unstandardized variables are used.
...
> ANSWER:  The variability differs depending on the plot and variable being plotted.
